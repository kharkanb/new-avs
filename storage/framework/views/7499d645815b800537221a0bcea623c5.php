...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'سیستم بازدید تجهیزات'); ?></title>
...
<li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('advanced.dashboard')); ?>">
        <i class="bi bi-graph-up"></i> <span>داشبورد پیشرفته</span>
    </a>
</li>
            <a class="nav-link <?php echo e(request()->routeIs('inspection.form') ? 'active' : ''); ?>" href="<?php echo e(route('inspection.form')); ?>">
                <i class="bi bi-clipboard-check"></i> <span>فرم بازدید</span>
            </a>
            <a class="nav-link <?php echo e(request()->routeIs('dashboard.inspections') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.inspections')); ?>">
            ...
            <div class="nav-dropdown" id="dataBankDropdown">
                ...
                <div class="nav-submenu">
                    <a class="nav-link" href="<?php echo e(route('dashboard.contractors.index')); ?>">مدیریت پیمانکاران</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.departments.index')); ?>">مدیریت امورها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.posts.index')); ?>">مدیریت پست‌ها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.feeders.index')); ?>">مدیریت فیدرها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.brands.index')); ?>">مدیریت برندها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.equipment-types.index')); ?>">انواع تجهیزات اصلی</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.cell-equipment-types.index')); ?>">انواع تجهیزات سلولی</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.activity-prices.index')); ?>">فهرست بها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.checklist-items.index')); ?>">چک‌لیست‌ها</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.simcard-types.index')); ?>">انواع سیم‌کارت</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.users.index')); ?>">مدیریت کاربران</a>
                    <a class="nav-link" href="<?php echo e(route('dashboard.activity-logs')); ?>">گزارش فعالیت‌ها</a>
                </div>
            </div>
            <?php endif; ?>
        </nav>
        ...
        <div class="top-bar">
            ...
            <div class="user-info d-flex align-items-center gap-3">
                <div class="user-details text-end">
                    <p class="user-name mb-0 fw-bold"><?php echo e(auth()->user()->name); ?></p>
...
</html><?php /**PATH C:\Users\dear-user\Desktop\new-avs\resources\views/layouts/admin.blade.php ENDPATH**/ ?>